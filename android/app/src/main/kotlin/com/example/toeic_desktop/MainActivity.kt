                ...
                .setMethodCallHandler { call, result ->
                    when (call.method) {
                        ...
                        "schedulePeriodicWidgetUpdate" -> {
                            val data =
                                    call.argument<HashMap<String, Any>>("flashCardShowInWidgetList")
                            if (data != null) {
                                val list =
                                        data["flashCardShowInWidgetList"] as?
                                ...
                                if (list != null) {
                                    ...
                                    if (flashcards.isNotEmpty()) {
                                        ...
                                        CoroutineScope(Dispatchers.IO).launch {
                                            ...
                                            try {
                                                TOEICGlanceWidget.updateSpecificWidgetByGlanceId(
                                                        this@MainActivity,
                                                        flashcards.first()
                                                )
                                            } catch (_: Exception) {}
                                            try {
                                                FlashcardListGlanceWidget
                                                        .updateListStateWithAllFlashcards(
                                                                this@MainActivity
                                                        )
                                            } catch (_: Exception) {}

                                            if (!WidgetWorkScheduler.isWorkManagerRunning(
                                                            this@MainActivity
                                                    )
                                            ) {
                                                val reminderWordAfterTime =
                                                        ContentPreferences.getReminderWordAfterTime(
                                                                this@MainActivity
                                                        )
                                                val value =
                            ...
                            result.success(
                                    "Widget update scheduled after ${ContentPreferences.getReminderWordAfterTime(this)}"
                            )
                        }
                        "updateReminderWordAfterTime" -> {
                            val reminderWordAfterTime =
                                    call.argument<String>("reminderWordAfterTime")
                            if (reminderWordAfterTime != null) {
                                ContentPreferences.setReminderWordAfterTime(
                                        this,
                                        reminderWordAfterTime
                                )
                            }
                                ...
                                if (flashCards.isNotEmpty()) {
                                    ...
                                    CoroutineScope(Dispatchers.IO).launch {
                                        if (WidgetWorkScheduler.isWorkManagerRunning(
                                            ...
                                            WidgetWorkScheduler.cancelWidgetUpdate(
                                                    this@MainActivity,
                                        ...
                                        WidgetWorkScheduler.schedulePeriodicWidgetUpdate(
                                                this@MainActivity,
                                                value,
                                                timeUnit
                                        )
                                    ...
                                    result.success(
                                            "Widget update scheduled after $reminderWordAfterTime"
                                    )
                                } else {
