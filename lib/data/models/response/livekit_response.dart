...
LivekitResponse livekitResponseFromJson(String str) =>
    LivekitResponse.fromJson(json.decode(str));

String livekitResponseToJson(LivekitResponse data) =>
...
class LivekitResponse {
  ...
  factory LivekitResponse.fromJson(Map<String, dynamic> json) =>
      _$LivekitResponseFromJson(json);
