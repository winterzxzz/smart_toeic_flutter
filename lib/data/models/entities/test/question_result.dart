...
List<QuestionResult> questionResultFromJson(String str) =>
    List<QuestionResult>.from(
        json.decode(str).map((x) => QuestionResult.fromJson(x)));

String questionResultToJson(List<QuestionResult> data) =>
