...
class _ApiClient implements ApiClient {
  ...
  Future<NewSetFlashCardLearning> updateFlashCardLearning(
    ...
    final _options = _setStreamType<NewSetFlashCardLearning>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<PaymentStatus> checkPaymentStatus(String transId) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<PaymentStatus>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<QuestionExplain> getExplanation(QuestionExplainRequest request) async {
    ...
    final _data = <String, dynamic>{};
    _data.addAll(request.toJson());
    final _options = _setStreamType<QuestionExplain>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<List<WordRandom>> getRandom4Words() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<WordRandom>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<RoomDb> createRoom(CreateRoomRequest request) async {
    ...
    final _data = <String, dynamic>{};
    _data.addAll(request.toJson());
    final _options = _setStreamType<RoomDb>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
